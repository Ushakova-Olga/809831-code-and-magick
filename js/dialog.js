...
/* 5. Перетаскивание окна */
/* Перетаскивать за элемент .setup-user-pic не выходит, чтобы
это получилось надо убрать div .upload, в который он вложен.
Но убрать нельзя, т.к. upload нужен */
